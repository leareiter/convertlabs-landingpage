...
export default function DesignMVPUseCases() {
  ...
  const testimonials = [
    {
      quote: "ConvertLabs nous a livré un MVP en 6 semaines. Nos investisseurs ont été bluffés par la qualité du prototype.",
      author: "Sarah M.",
      role: "Fondatrice, FinTech"
    },
    {
      quote: "L'équipe a parfaitement compris nos besoins. Le processus était transparent et les livrables de qualité.",
      author: "Marc L.",
      role: "CEO, PME Tech"
    },
    {
      quote: "Grâce à leur expertise ASO, notre app a vu ses téléchargements tripler en 2 mois.",
      author: "Julie K.",
