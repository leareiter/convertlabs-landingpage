...
export default function AutomatisationCRMHero() {
  const hero = useMemo(() => ({
    badgeText: "CRM & Automatisation",
    title: "Organise ton back-office pour qu'il tourne sans toi",
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <h1 className="text-[40px] lg:text-7xl tracking-[-0.05em] mb-8 md:mb-12 leading-tight text-center text-text-hero">
            <span ref={text1Ref} className="block font-be-vietnam-pro font-medium">Organise</span>
            <span ref={text2Ref} className="block font-be-vietnam-pro font-medium">ton back-office</span>
            <div className="flex items-center justify-center gap-4">
              <span ref={text3Ref} className="block mt-2 font-be-vietnam-pro font-medium">pour qu&apos;il </span>
