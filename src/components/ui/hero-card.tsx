              ...
              <>
                ...
                <div className="block md:hidden">
                  ...
                  <span 
                    ...
                    className={`inline-block font-times-new-roman text-6xl font-medium md:text-8xl italic ${brandColor} ${brandColor === "bg-brand-green" ? "text-black" : "text-white"} px-6 py-2 rounded-md shadow-xs hover:-translate-y-2 transition-all duration-300 ease-out cursor-pointer transform rotate-2 opacity-0`}
                  >
                    {titleHighlight}
                  </span>
                </div>
